...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-data", "3.0.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-data")
        description.set("kotlin-data")
        url.set("https://github.com/wabbit-corp/kotlin-data")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-data")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-data.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-data.git")
        }
    }
}

...
// managed-integrity-v1: RuR2J5WyrSK
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-data", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-data")
        description.set("Kotlin Multiplatform data structures, primitive buffers, persistent collections, and functional value types.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-data"

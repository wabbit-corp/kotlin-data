...
- Canonical repo target: `kotlin-data`. Useful entrypoints: `dev project show kotlin-data`, `dev build kotlin-data`, `dev check kotlin-data`.
- Setup-managed files are regenerated with `dev setup kotlin-data`; avoid hand-editing stamped generated files.

...
class BooleanDeque(
    ...
    class Iterator(private val deque: BooleanDeque) : kotlin.collections.Iterator<Boolean> {
        ...
        override fun next(): Boolean = deque[index++]
    }
    ...
    /**
     * Serializer: just store it as a List<Boolean> internally.
     */
    class TypeSerializer : KSerializer<BooleanDeque> {
        ...
        override fun deserialize(decoder: Decoder): BooleanDeque {
            ...
            return BooleanDeque(list.toBooleanArray())
        }
    }

    companion object {
        val empty: BooleanDeque = BooleanDeque(0)

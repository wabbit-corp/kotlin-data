...
/**
 * Mutable contiguous buffer for primitive chars.
 *
...
class CharBuffer(@JvmField internal var capacity: Int = 16) {
     ...
     */
    class MutableIterator(private val buf: CharBuffer) :
        kotlin.collections.MutableIterator<Char> {
        private var index = 0
...
/**
 * Build a [CharBuffer] containing [values].
 */

...
/**
 * Mutable ring-buffer deque for primitive floats.
 *
...
class FloatDeque(initialCapacity: Int = 16) {
    ...
    fun toList(): List<Float> {
        val result = ArrayList<Float>(usedSize)
    ...
    fun toFloatArray(): FloatArray {
        val result = FloatArray(usedSize)
        for (i in 0 until usedSize) {
    ...
    companion object {
        ...
        fun empty(): FloatDeque = FloatDeque(0)
...
/** Copy this primitive array into a new [FloatDeque]. */
